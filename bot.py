...
rarities = {
    "大吉": ["やったね","もはや運使い切った説","神引ききたこれ",  "やるやん"],
    "中吉": ["良き", "ええやん", "なかなか","普通にいい日", "いい引き","運きてる"],
    "小吉": ["悪くはないか一旦", "まぁまぁ", "ちょっとラッキー",
        "小当たりやね（しってる）", "コツコツ貯めてこ", "地味にいいかも",
        "良い日になる…かも？", "控えめにいい日", "積み重ね。"],
    "吉": ["普通やね", "まぁまぁ", "可もなく不可もなく",
        "平和が一番", "安定してる", "悪くない",
        "無難無難", "落ち着いて一日過ごそ"],
    "凶": ["のびしろやで", "おつ","もう下がらないねラッキー（？）", "逆に神引き", "無理せんとこ"],
    "末吉": ["まぁまぁ", "まぁ、人による", "微妙なところ",
        "あと一歩感", "全部惜しい一日", "悪くはないよ…きっと",],
    "半吉": ["半分のラッキーがあるさ", "中途半端やね", "まぁ、悪くはないかも",
        "どっちとも言えんやつ", "判断むずい日",
        "使い方次第で化ける", "様子見が大事な一日",
        "ワンチャン？", "振れ幅でかそう", "中吉の半分説", "凶の半分説（？）",
        "大吉の半分説"],
    "ぜむ吉": ["やほ、ぜむだよ", "なぁ…なぁ！", "おつ", "ぜむじゃないよ", "ガチャ回数+1!おめ"]
}
